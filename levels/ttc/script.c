...
const LevelScript level_ttc_entry[] = {
	...
	AREA(1, ttc_area_1),
		...
		OBJECT(MODEL_NONE, 10384, 5558, -834, 0, -141, 0, 0x00060000, bhvFadingWarp),
		OBJECT(MODEL_CASTLE_GROUNDS_CASTLE_DOOR, 10139, 2623, -1311, 0, -169, 0, 0x00030000, bhvDoorWarp),
		OBJECT(MODEL_CASTLE_GROUNDS_CASTLE_DOOR, 6444, -5657, 3809, 0, -177, 0, 0x00040000, bhvDoorWarp),
		OBJECT(MODEL_CASTLE_GROUNDS_CASTLE_DOOR, 6443, -5657, 421, 0, 3, 0, 0x00070000, bhvDoorWarp),
		OBJECT(MODEL_STAR, 7054, -1742, -4812, 0, -123, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, 6387, -5428, 2454, 0, -123, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, -123, 6387, -5428, 2454),
		OBJECT(MODEL_NONE, 9427, 4008, -2030, 0, 57, 0, 0x00020000, bhvWarp),
		OBJECT(MODEL_NONE, 3245, -5651, -1969, 0, 57, 0, 0x00050000, bhvFadingWarp),
