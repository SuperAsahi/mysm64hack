...
const LevelScript level_ttc_entry[] = {
	...
	AREA(1, ttc_area_1),
		...
		OBJECT(MODEL_WMOTR_WOODEN_DOOR, 4142, 7342, -2280, 0, 0, 0, 0x00030000, bhvDoorWarp),
		...
		OBJECT(MODEL_NONE, 7082, 1663, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 7082, 1663, 0),
		OBJECT(MODEL_NONE, 4101, 8587, -1696, 0, 0, 0, 0x00020000, bhvWarp),
		OBJECT(MODEL_NONE, 7554, -5651, 3409, 0, -180, 0, 0x00050000, bhvFadingWarp),
		OBJECT(MODEL_WMOTR_WOODEN_DOOR, -3512, 10474, -11581, 0, 174, 0, 0x00080000, bhvDoorWarp),
		OBJECT(MODEL_TTC_ELEVATOR_PLATFORM, -3592, 10618, -10633, 0, 0, 0, 0x00000000, bhvTTCElevator),
		OBJECT(MODEL_TTC_ELEVATOR_PLATFORM, -3151, 11199, -10633, 0, 0, 0, 0x00000000, bhvTTCElevator),
		OBJECT(MODEL_TTC_ELEVATOR_PLATFORM, -4037, 11934, -10633, 0, 0, 0, 0x00000000, bhvTTCElevator),
		OBJECT(MODEL_TTC_ELEVATOR_PLATFORM, -3291, 12733, -10633, 0, 0, 0, 0x00000000, bhvTTCElevator),
		OBJECT(MODEL_NONE, -3291, 13118, -10633, 0, 0, 0, 0x00010000, bhvWarp),
