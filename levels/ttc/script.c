...
const LevelScript level_ttc_entry[] = {
	...
	AREA(1, ttc_area_1),
		...
		OBJECT(MODEL_HMC_WOODEN_DOOR, 4300, 2623, -2705, 0, -45, 0, 0x00030000, bhvDoorWarp),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_CASTLE_DOOR, -4527, 10474, -10443, 0, -86, 0, 0x00080000, bhvDoorWarp),
