...
const GeoLayout rr_dl_room02_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -11272, 2715, -6502, 0, -20, 0, rr_dl_blj_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -10033, 1726, -4561, 0, -42, 0, rr_dl_Cube_008_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -11160, 2761, -4364, 0, 87, 4, rr_dl_Cube_032_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -6428, 3711, 1929, 0, 16, 0, rr_dl_Cube_033_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -1037, 0, rr_dl_deathplane_mesh_layer_5),
