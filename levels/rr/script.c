...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		OBJECT(MODEL_GOOMBA, -8971, 6817, 6869, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		...
		OBJECT(MODEL_BOB_BUBBLY_TREE, -15140, 2392, -9179, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_BOB_BUBBLY_TREE, -8684, 1489, -7102, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_FLYGUY, 4474, 811, -7407, 0, -35, 0, 0x00000000, bhvFlyGuy),
		OBJECT(MODEL_GOOMBA, -2203, 155, -9999, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_YELLOW_COIN, 7165, 1078, -3831, 0, 93, 0, 0x00000000, bhvTenCoinsSpawn),
		OBJECT(MODEL_YELLOW_COIN, 3421, 532, -6348, 0, 93, 0, 0x00000000, bhvThreeCoinsSpawn),
