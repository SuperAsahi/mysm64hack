...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		OBJECT(MODEL_BLACK_BOBOMB, 6155, -1860, -5934, 0, 0, 0, 0x00000000, bhvBobomb),
		OBJECT(MODEL_WMOTR_WOODEN_DOOR, -301, -8, 861, 0, -45, 0, 0x00010000, bhvDoorWarp),
		OBJECT(MODEL_GOOMBA, 2840, -1449, -5546, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		MARIO_POS(0x01, 0, 0, 87, 0),
		OBJECT(MODEL_BOB_BUBBLY_TREE, 4072, -895, -1383, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_BOB_BUBBLY_TREE, 1615, -877, -3365, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_BOB_BUBBLY_TREE, 3173, -928, -61, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_BOB_BUBBLY_TREE, 5961, -1885, -5279, 0, 0, 0, 0x00000000, bhvTree),
