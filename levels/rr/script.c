...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, -11354, 2628, -6385, 0, 0, 0, (165 << 16), bhvSignOnWall),
		...
		OBJECT(MODEL_BITDW_WARP_PIPE, -14377, 2552, -9271, 0, 108, 0, (02 << 16), bhvWarpPipe),
		...
		OBJECT(MODEL_NONE, -3880, 4387, -2461, 0, 0, 0, 0x00000000, bhvHiddenStar),
