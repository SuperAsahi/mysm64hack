...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, 169, 332, 537, 0, 0, 0, 0x00000000, bhvHiddenStar),
		OBJECT(MODEL_WOODEN_SIGNPOST, -689, 100, 491, 0, 0, 0, (169 << 16), bhvSignOnWall),
		OBJECT(MODEL_BUTTERFLY, -61, 149, 440, 0, 88, 0, 0x00000000, bhvHiddenStarTrigger),
