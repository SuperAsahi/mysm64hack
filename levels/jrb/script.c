...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_BLUE_FLAME, 451, 1055, -7483, 0, 24, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_BLUE_FLAME, 1891, 1055, -8080, 0, 24, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_WOODEN_SIGNPOST, 2617, 1026, 9639, 0, 86, 0, (169 << 16), bhvSignOnWall),
		OBJECT(MODEL_STAR, 1008, 1119, -8323, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, 7637, 1410, 8717, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 7637, 1410, 8717),
		OBJECT(MODEL_BITDW_WARP_PIPE, 7959, 1248, 8583, 0, -69, 0, (01 << 16), bhvWarpPipe),
