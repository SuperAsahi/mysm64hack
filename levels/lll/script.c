...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_BLACK_BOBOMB, 8703, 2660, -7528, 0, 0, 0, 0x00000000, bhvBobomb),
		OBJECT(MODEL_BULLY, 8825, 2659, -2465, 0, 0, 0, 0x00000000, bhvSmallBully),
		MARIO_POS(0x01, 0, 2141, 2871, -5726),
		OBJECT(MODEL_NONE, 7472, 2763, -4096, 0, 25, 0, (163 << 16), bhvSignOnWall),
		OBJECT(MODEL_STAR, 7114, 5120, -5201, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, 2141, 2985, -5726, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 2359, 3653, -8083, 0, 114, 0, (01 << 16), bhvFadingWarp),
